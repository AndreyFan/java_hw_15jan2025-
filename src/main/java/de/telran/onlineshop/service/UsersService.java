...
//        UsersEntity user1 = new UsersEntity(null, "Peter", "peter@gmail/com", "+4915121748923", "peter45", Role.ADMINISTRATOR, cart1, null, null);
//        usersRepository.save(user1);
//
//        CartEntity cart2 = new CartEntity();
//        cart2 = cartsRepository.save(cart2);
//        UsersEntity user2 = new UsersEntity(null, "Olga", "olga@gmail/com", "+4915121748977", "olga24", Role.CLIENT, cart2, null, null);
//        usersRepository.save(user2);
//
//        CartEntity cart3 = new CartEntity();
//        cart3 = cartsRepository.save(cart3);
//        UsersEntity user3 = new UsersEntity(null, "Anna", "Anna@gmail/com", "+4915121748753", "Anna41", Role.CLIENT, cart3, null, null);
//        usersRepository.save(user3);
//
//        CartEntity cart4 = new CartEntity();
//        cart4 = cartsRepository.save(cart4);
//        UsersEntity user4 = new UsersEntity(null, "Max", "max@gmail/com", "+4915735748923", "max27", Role.CLIENT, cart4, null, null);
//        usersRepository.save(user4);
//
//        CartEntity cart5 = new CartEntity();
//        cart5 = cartsRepository.save(cart5);
//        UsersEntity user5 = new UsersEntity(null, "Irina", "irina@gmail/com", "+4912115856727", "irina31", Role.CLIENT, cart5, null, null);
...
//    }
    ...
    public UserDto getUserByName(String name) {
        ...
        return new UserDto(usersEntity.getUserId(), usersEntity.getName(), usersEntity.getEmail(), usersEntity.getPhoneNumber(), usersEntity.getPasswordHash(), usersEntity.getRole());
    }
