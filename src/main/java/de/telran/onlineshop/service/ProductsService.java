...
//    public ProductDto getProductByID(Long id) {
//        ProductsEntity productsEntity = productsRepository.findById(id).orElse(new ProductsEntity());
//        ProductDto productDtoResult = convertProdEntToDTO(productsEntity);
...
//
//    public ProductDto convertProdEntToDTO(ProductsEntity productsEntity){
//        ProductDto productDto = new ProductDto();
//        productDto.setProductID(productsEntity.getProductId());
...
//        productDto.setDiscountPrice(productsEntity.getDiscountPrice());
//        productDto.setCreatedAt(productsEntity.getCreatedAt());
//        productDto.setUpdatedAt(productsEntity.getUpdatedAt());
//          return productDto ;
//
//    }
